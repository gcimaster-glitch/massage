...
-- 施設データ投入（実際のスキーマに合わせる）
INSERT OR IGNORE INTO sites (id, host_id, name, type, address, area, lat, lng, amenities, status, room_count, is_active, created_at) VALUES
('site-shibuya-1', 'host-shibuya', 'HOGUSY 渋谷スタジオ', 'HOTEL', '東京都渋谷区道玄坂2-10-7', '渋谷区', 35.6595, 139.6983, 
 '["シャワー完備","アメニティ","Wi-Fi","ロッカー"]', 'PENDING', 3, 1, datetime('now')),

('site-shinjuku-1', 'host-shinjuku', 'HOGUSY 新宿プレミアム', 'HOTEL', '東京都新宿区西新宿1-1-3', '新宿区', 35.6896, 139.6917,
 '["高級アメニティ","シャワー完備","タオル無料","Wi-Fi","待合スペース"]', 'PENDING', 3, 1, datetime('now')),

('site-roppongi-1', 'host-roppongi', 'HOGUSY 六本木ヒルズ', 'HOTEL', '東京都港区六本木6-10-1', '港区', 35.6604, 139.7292,
 '["高級アメニティ","シャワー完備","バスローブ","スパ施設","Wi-Fi","駐車場"]', 'PENDING', 3, 1, datetime('now'));

-- 施設の部屋データ（実際のスキーマに合わせる）
INSERT OR IGNORE INTO site_rooms (id, site_id, room_number, is_available, created_at) VALUES
('room-shibuya-1', 'site-shibuya-1', '101', 1, datetime('now')),
('room-shibuya-2', 'site-shibuya-1', '102', 1, datetime('now')),
('room-shibuya-3', 'site-shibuya-1', '201', 1, datetime('now')),

('room-shinjuku-1', 'site-shinjuku-1', '301', 1, datetime('now')),
('room-shinjuku-2', 'site-shinjuku-1', '302', 1, datetime('now')),
('room-shinjuku-3', 'site-shinjuku-1', '401', 1, datetime('now')),

('room-roppongi-1', 'site-roppongi-1', '501', 1, datetime('now')),
('room-roppongi-2', 'site-roppongi-1', '502', 1, datetime('now')),
('room-roppongi-3', 'site-roppongi-1', '601', 1, datetime('now'));
...
-- マスターオプション
INSERT OR IGNORE INTO master_options (id, name, description, duration, base_price, created_at) VALUES

      ...
      <div className="bg-white rounded-[64px] shadow-2xl p-10 md:p-16 max-w-3xl w-full relative border border-gray-100 overflow-hidden">
        ...
        <div className="mb-8 space-y-3">
          ...
          <button
            ...
            type="button"
            className="w-full p-4 border-2 border-transparent rounded-[24px] flex items-center justify-center gap-3 transition-all hover:opacity-90 hover:shadow-lg active:scale-[0.98] bg-[#06C755]"
          >
            ...
            <span className="font-black text-white">LINE で登録</span>
          </button>
        </div>

        <div className="py-4 flex items-center gap-4 mb-8">
          <div className="flex-1 h-px bg-gray-100"></div>
          <span className="text-[9px] font-black text-gray-300 uppercase tracking-widest">またはメールで登録</span>
          <div className="flex-1 h-px bg-gray-100"></div>
        </div>

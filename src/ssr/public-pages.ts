...
app.get('/', (c) => {
  const html = renderPage({
    title: 'HOGUSY - ほぐす、を、もっと身近に。',
    description: 'HOGUSY（ホグシー）は、あなたの「ほぐしてほしい」を叶えるセラピスト予約プラットフォーム。AIで安全を守りながら、プロの施術を手軽にお届けします。',
    url: 'https://hogusy.com',
    body: `
    <!-- Hero Section -->
    <section class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden pt-16">
      <div class="absolute inset-0 opacity-20">
        <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-teal-500 rounded-full blur-[150px]"></div>
        <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-indigo-500 rounded-full blur-[150px]"></div>
      </div>
      <div class="relative z-10 text-center max-w-5xl mx-auto px-4 space-y-10">
        <p class="text-teal-400 text-sm font-black uppercase tracking-[0.4em]">Next-Generation Wellness Platform</p>
        <h1 class="text-5xl md:text-8xl font-black text-white tracking-tighter leading-[0.9]">
          ほぐす、を、<br/>
          <span class="text-teal-400">もっと身近に。</span>
        </h1>
        <p class="text-gray-400 text-lg md:text-2xl max-w-2xl mx-auto leading-relaxed font-medium">
          HOGUSYは、AIで安全を守りながら、<br class="hidden md:block"/>
          プロのセラピストとあなたをつなぐ<br class="hidden md:block"/>
          次世代のウェルネス・プラットフォームです。
        </p>
        <div class="flex flex-wrap justify-center gap-4 pt-6">
          <a href="/app/map" class="bg-teal-500 text-white px-10 py-5 rounded-[24px] font-black text-sm uppercase tracking-widest hover:bg-teal-600 transition-all shadow-2xl inline-flex items-center gap-3">
            マップで探す →
          </a>
          <a href="/recruit" class="bg-white/10 text-white border border-white/20 px-10 py-5 rounded-[24px] font-black text-sm uppercase tracking-widest hover:bg-white/20 transition-all backdrop-blur-sm inline-flex items-center gap-3">
            パートナー募集
          </a>
        </div>
      </div>
    ...
    <section class="py-24 bg-white">
      <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-black text-slate-900 tracking-tighter">かんたん3ステップ</h2>
          <p class="text-gray-400 font-bold mt-4">お近くの施設を見つけて、すぐに予約。</p>
        </div>
        <div class="grid md:grid-cols-3 gap-12">
          <div class="text-center space-y-4">
            <div class="w-20 h-20 bg-teal-50 rounded-[32px] flex items-center justify-center mx-auto text-teal-600 text-3xl font-black shadow-inner">1</div>
            <h3 class="text-xl font-black text-slate-900">場所を探す</h3>
            <p class="text-gray-500 font-bold text-sm leading-relaxed">マップから、お近くのCARE CUBEブースやホテル提携施設を検索。</p>
          </div>
          <div class="text-center space-y-4">
            <div class="w-20 h-20 bg-teal-50 rounded-[32px] flex items-center justify-center mx-auto text-teal-600 text-3xl font-black shadow-inner">2</div>
            <h3 class="text-xl font-black text-slate-900">セラピストを選ぶ</h3>
            <p class="text-gray-500 font-bold text-sm leading-relaxed">プロフィール、レビュー、専門技術を見て、あなたに合うセラピストを選択。</p>
          </div>
          <div class="text-center space-y-4">
            <div class="w-20 h-20 bg-teal-50 rounded-[32px] flex items-center justify-center mx-auto text-teal-600 text-3xl font-black shadow-inner">3</div>
            <h3 class="text-xl font-black text-slate-900">予約・施術</h3>
            <p class="text-gray-500 font-bold text-sm leading-relaxed">日時を選んで予約完了。Gemini AIライブ安全監視のもと、安心の施術を。</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-24 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-black text-slate-900 tracking-tighter">安全と信頼を、テクノロジーで</h2>
          <p class="text-gray-400 font-bold mt-4">業界初のAI安全監視で、すべての施術を見守ります。</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
          <div class="bg-white p-10 rounded-[48px] shadow-sm border border-gray-100 space-y-4">
            <div class="w-14 h-14 bg-teal-50 rounded-2xl flex items-center justify-center text-teal-600 font-black text-2xl">🛡</div>
            <h3 class="text-lg font-black text-slate-900">Gemini AI 安全監視</h3>
            <p class="text-sm text-gray-500 font-bold leading-relaxed">全施術中、AIが音声をリアルタイム分析。異常を検知すると即座にアラートを発信します。</p>
          </div>
          <div class="bg-white p-10 rounded-[48px] shadow-sm border border-gray-100 space-y-4">
            <div class="w-14 h-14 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 font-black text-2xl">✅</div>
            <h3 class="text-lg font-black text-slate-900">本人確認（KYC）</h3>
            <p class="text-sm text-gray-500 font-bold leading-relaxed">セラピスト全員に本人確認と資格審査を実施。信頼できるプロだけが登録しています。</p>
          </div>
          <div class="bg-white p-10 rounded-[48px] shadow-sm border border-gray-100 space-y-4">
            <div class="w-14 h-14 bg-orange-50 rounded-2xl flex items-center justify-center text-orange-600 font-black text-2xl">💳</div>
            <h3 class="text-lg font-black text-slate-900">安心の決済</h3>
            <p class="text-sm text-gray-500 font-bold leading-relaxed">Stripe決済で完全キャッシュレス。施術前に金額確定、後から追加請求はありません。</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-24 bg-slate-900 text-white text-center">
      <div class="max-w-3xl mx-auto px-4 space-y-8">
        <h2 class="text-4xl md:text-5xl font-black tracking-tighter">今すぐ、HOGUSYを体験</h2>
        <p class="text-gray-400 text-lg font-bold">お近くの施設を検索して、プロの施術を予約しましょう。</p>
        <div class="flex flex-wrap justify-center gap-4">
          <a href="/app/map" class="bg-teal-500 text-white px-10 py-5 rounded-[24px] font-black text-sm uppercase tracking-widest hover:bg-teal-600 transition-all shadow-2xl">施設を探す →</a>
          <a href="/signup" class="bg-white/10 text-white border border-white/20 px-10 py-5 rounded-[24px] font-black text-sm uppercase tracking-widest hover:bg-white/20 transition-all">無料会員登録</a>
        </div>
      </div>
    </section>
    `,

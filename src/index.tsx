...
app.post('/api/admin/run-migration', async (c) => {
  ...
  if (action === 'rebuild_bookings') {
    ...
    statements = [
      ...
      `INSERT INTO users (id, name, email, phone, role, password_hash, email_verified, created_at, updated_at) VALUES ('customer-1', '山田 花子', 'hanako.yamada@example.com', '090-5678-0001', 'CUSTOMER', 'pbkdf2:10000:K8xuogSxCqgJTM7i5nHbgQ==:JyFALM85bPQGPYjk1LRvxa8pJYjudcjPdJK4BSKfHxA=', 1, '2026-03-01 09:00:00', '2026-06-30 00:00:00')`,
      `INSERT INTO users (id, name, email, phone, role, password_hash, email_verified, created_at, updated_at) VALUES ('customer-2', '鈴木 太郎', 'taro.suzuki@example.com', '090-5678-0002', 'CUSTOMER', 'pbkdf2:10000:K8xuogSxCqgJTM7i5nHbgQ==:JyFALM85bPQGPYjk1LRvxa8pJYjudcjPdJK4BSKfHxA=', 1, '2026-03-15 09:00:00', '2026-06-30 00:00:00')`,
      ...
      // セラピストプロフィール
      `INSERT INTO therapist_profiles (id, user_id, name, email, phone, avatar_url, bio, specialties, experience_years, certifications, rating, review_count, approved_areas, status, commission_rate, outcall_available, incall_available, base_location, base_lat, base_lng, travel_methods, outcall_hours, incall_hours) VALUES ('tp-1', 'therapist-1', '高橋 大地', 'daichi.takahashi@hogusy.com', '090-1234-0001', '/therapists/therapist-1.jpg', '鍼灸師・柔道整復師の資格保有。スポーツ障害や慢性痛の改善を得意としています。', '["鍼灸","柔道整復","スポーツケア"]', 11, '["鍼灸師","柔道整復師","アスレティックトレーナー"]', 4.9, 156, '["shibuya","shinjuku","minato","meguro","setagaya"]', 'APPROVED', 70, 1, 1, '東京都渋谷区神宮前3-5-10', 35.6708, 139.7073, '["電車","タクシー"]', '{"start":"09:00","end":"21:00"}', '{"start":"10:00","end":"20:00"}')`,
      `INSERT INTO therapist_profiles (id, user_id, name, email, phone, avatar_url, bio, specialties, experience_years, certifications, rating, review_count, approved_areas, status, commission_rate, outcall_available, incall_available, base_location, base_lat, base_lng, travel_methods, outcall_hours, incall_hours) VALUES ('tp-2', 'therapist-2', '佐藤 美咲', 'misaki.sato@hogusy.com', '090-1234-0002', '/therapists/therapist-2.jpg', 'アロマセラピスト・リフレクソロジスト。女性特有の不調やストレスケアを専門としています。', '["アロマ","リフレクソロジー","フェイシャル"]', 8, '["AEAJ認定アロマセラピスト","リフレクソロジスト"]', 4.8, 98, '["shibuya","minato","meguro","setagaya","ota"]', 'APPROVED', 70, 1, 1, '東京都目黒区自由が丘2-8-15', 35.6073, 139.6686, '["電車"]', '{"start":"10:00","end":"20:00"}', '{"start":"10:00","end":"19:00"}')`,
      `INSERT INTO therapist_profiles (id, user_id, name, email, phone, avatar_url, bio, specialties, experience_years, certifications, rating, review_count, approved_areas, status, commission_rate, outcall_available, incall_available, base_location, base_lat, base_lng, travel_methods, outcall_hours, incall_hours) VALUES ('tp-3', 'therapist-3', '田中 健太', 'kenta.tanaka@hogusy.com', '090-1234-0003', '/therapists/therapist-3.jpg', '整体師・パーソナルトレーナー。姿勢改善と運動指導を組み合わせた独自メソッドで根本改善。', '["整体","パーソナルトレーニング","姿勢矯正"]', 6, '["柔道整復師","NSCA-CPT"]', 4.7, 72, '["shinjuku","chiyoda","bunkyo","toshima","nakano"]', 'APPROVED', 70, 1, 0, '東京都新宿区西新宿1-12-3', 35.6938, 139.7003, '["電車","自転車"]', '{"start":"08:00","end":"22:00"}', '{}')`,
      // スケジュール
      ...
      // サイト
      `INSERT INTO sites (id, name, address, lat, lng, phone, description, area_code, status, created_at) VALUES ('site-shibuya', '渋谷サロン', '東京都渋谷区道玄坂2-10-7 新大宗ビル5F', 35.6580, 139.6994, '03-1234-5001', '渋谷駅徒歩3分の完全個室サロン', 'shibuya', 'ACTIVE', '2026-01-01 00:00:00')`,
      `INSERT INTO sites (id, name, address, lat, lng, phone, description, area_code, status, created_at) VALUES ('site-shinjuku', '新宿サロン', '東京都新宿区西新宿1-5-11 新宿三葉ビル8F', 35.6896, 139.6922, '03-1234-5002', '新宿駅西口徒歩2分', 'shinjuku', 'ACTIVE', '2026-01-01 00:00:00')`,
      `INSERT INTO sites (id, name, address, lat, lng, phone, description, area_code, status, created_at) VALUES ('site-meguro', '目黒サロン', '東京都目黒区目黒1-4-16 目黒Gビル3F', 35.6334, 139.7158, '03-1234-5003', '目黒駅徒歩5分', 'meguro', 'ACTIVE', '2026-01-01 00:00:00')`,
      // 予約
      `INSERT INTO bookings (id, user_id, therapist_id, site_id, type, status, scheduled_at, duration, total_price, guest_name, guest_email, guest_phone, customer_address, postal_code, notes, created_at, updated_at) VALUES ('booking-001', 'customer-1', 'therapist-1', 'site-shibuya', 'ONSITE', 'PENDING', '2026-07-05 14:00:00', 60, 9000, NULL, NULL, NULL, NULL, NULL, '肩こりがひどいです', '2026-06-28 10:00:00', '2026-06-28 10:00:00')`,
      `INSERT INTO bookings (id, user_id, therapist_id, site_id, type, status, scheduled_at, duration, total_price, guest_name, guest_email, guest_phone, customer_address, postal_code, notes, created_at, updated_at) VALUES ('booking-002', 'customer-2', 'therapist-2', 'site-meguro', 'ONSITE', 'CONFIRMED', '2026-07-03 11:00:00', 60, 8500, NULL, NULL, NULL, NULL, NULL, 'リラックスしたい', '2026-06-25 15:00:00', '2026-06-26 09:00:00')`,
      `INSERT INTO bookings (id, user_id, therapist_id, site_id, type, status, scheduled_at, duration, total_price, guest_name, guest_email, guest_phone, customer_address, postal_code, notes, created_at, updated_at) VALUES ('booking-003', 'customer-1', 'therapist-1', NULL, 'MOBILE', 'CONFIRMED', '2026-07-07 10:00:00', 90, 12000, NULL, NULL, NULL, '東京都渋谷区神宮前1-2-3 マンション405', '150-0001', 'スポーツ後のケア希望', '2026-06-27 18:00:00', '2026-06-28 08:00:00')`,
      `INSERT INTO bookings (id, user_id, therapist_id, site_id, type, status, scheduled_at, duration, total_price, guest_name, guest_email, guest_phone, customer_address, postal_code, notes, created_at, updated_at) VALUES ('booking-004', 'customer-2', 'therapist-3', 'site-shinjuku', 'ONSITE', 'COMPLETED', '2026-06-20 15:00:00', 60, 8000, NULL, NULL, NULL, NULL, NULL, '姿勢が気になる', '2026-06-18 12:00:00', '2026-06-20 16:00:00')`,
      `INSERT INTO bookings (id, user_id, therapist_id, site_id, type, status, scheduled_at, duration, total_price, guest_name, guest_email, guest_phone, customer_address, postal_code, notes, created_at, updated_at) VALUES ('booking-005', NULL, 'therapist-2', 'site-shibuya', 'ONSITE', 'PENDING', '2026-07-08 13:00:00', 45, 7000, '伊藤 さくら', 'sakura.ito@example.com', '080-9999-1234', NULL, NULL, 'フェイシャル希望', '2026-06-29 20:00:00', '2026-06-29 20:00:00')`,
      `INSERT INTO bookings (id, user_id, therapist_id, site_id, type, status, scheduled_at, duration, total_price, guest_name, guest_email, guest_phone, customer_address, postal_code, notes, created_at, updated_at) VALUES ('booking-006', NULL, 'therapist-3', NULL, 'MOBILE', 'PENDING', '2026-07-10 09:00:00', 90, 11000, '中村 翔太', 'shota.nakamura@example.com', '070-8888-5678', '東京都新宿区高田馬場4-5-6 ハイツ302', '169-0075', '腰痛改善希望', '2026-06-30 08:00:00', '2026-06-30 08:00:00')`,
      // 予約アイテム
